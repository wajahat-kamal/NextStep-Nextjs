...
export default async function ShoppingPage() {
    ...
    return (
        <div className='min-h-screen'>
            ...
            {/* filters */}
            <section className='w-full h-25 px-6 md:px-16 flex md:flex-row flex-col items-center gap-4'>
                <input className='placeholder-gray-600 w-[45%] rounded bg-amber-50 py-2 px-4' type="text" placeholder='Search your favrit shoe' />
