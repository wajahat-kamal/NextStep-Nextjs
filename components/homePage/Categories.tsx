...
async function Categories() {
    ...
    return (
        <section className="bg-secondary/5 px-6 md:px-24 py-24">

            {/* Header */}
            <div className="flex flex-row justify-between items-center mb-14 gap-4">
                <div>
                    <p className="text-[10px] uppercase tracking-[0.3em] font-semibold mb-2 inline-block px-2 py-0.5 bg-primary text-secondary">
                        Browse By
                    </p>
                    <h2 className="text-xl sm:text-3xl md:text-5xl font-black text-primary leading-tight">
                        Shop By{" "}
                        <span className="text-transparent"
                            style={{ WebkitTextStroke: "1.5px #021B41" }}>
                            Category
                        </span>
                    </h2>
                </div>
                <Link
                    href="/shopping"
                    className="flex items-center gap-1 text-[10px] md:text-xs uppercase tracking-wider font-semibold px-3 py-2 md:px-6 md:py-3 transition-all duration-300 shrink-0 border border-primary/40 text-primary hover:bg-primary hover:text-secondary"
                >
                    All Shoes
